...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+1, "# Author: TL Song") 
		call append(line(".")+2, "# mail: songtianlun@frytea.com") 
...
- [Vim安装插件管理器Vundle](https://blog.frytea.com/archives/419/)
- [Ubuntu下为vim安装YouCompleteMe插件](https://blog.frytea.com/archives/419/)